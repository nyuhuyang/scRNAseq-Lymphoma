...
DLBCL.primary.rename_ident <- Identify_Cell_Types_Spearman(object = DLBCL.primary, 
                                       gendata = ImmGenData.summary,
                                       cluster_rows=T,cluster_cols = T,
                                       title = "Spearman correlation: DLBCL.primary vs ImmGen Data")
DLBCL.PDX.rename_ident <- Identify_Cell_Types_Spearman(object = DLBCL.PDX, 
                                       gendata = ImmGenData.summary,
                                       cluster_rows=T,cluster_cols = T,
                                        title = "Spearman correlation: DLBCL.PDX vs ImmGen Data")
